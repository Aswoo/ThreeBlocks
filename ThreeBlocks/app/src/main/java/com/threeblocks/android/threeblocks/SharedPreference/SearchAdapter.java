...
import com.threeblocks.android.threeblocks.R;

import java.util.ArrayList;

/**
 * Created by seungwoo on 2017-08-03.
 */
...
public class SearchAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            ...
            recentDrawable = mContext.getResources().getDrawable(R.drawable.ic_pin_drop, null);

        } else {
            searchDrawable = mContext.getResources().getDrawable(R.drawable.ic_magnify_grey600_24dp);
            recentDrawable = mContext.getResources().getDrawable(R.drawable.ic_pin_drop);
        }
        if(mIsFilterList) {
